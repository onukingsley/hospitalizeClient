...
const AdminLayout = () => {
    ...
    const navLink = [
        ...
        { label: 'Patients', path: '/admin/patient', icon: 'Users', roles: ['admin'] },
        { label: 'Drugs', path: '/admin/drugs', icon: 'Users', roles: ['admin'] },
        { label: 'Lab Equipments', path: '/admin/labStock', icon: 'Users', roles: ['admin'] },
