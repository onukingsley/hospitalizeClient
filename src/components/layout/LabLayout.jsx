...
const LabLayout = () => {
    ...
    //    { label: 'Tests & Results', path: '/lab/tests', icon: 'FlaskConical', roles: ['labScientist'] },
        { label: 'Tests & Results', path: '/lab/patients', icon: 'FlaskConical', roles: ['labScientist'] },
      //  { label: 'Lab Reports', path: '/lab/reports', icon: 'FileText', roles: ['labScientist'] },
        ...
        { label: 'All labTests', path: '/lab/alllabtest', icon: 'Wrench', roles: ['labScientist'] },
        { label: 'Add equipment', path: '/lab/addlabstock', icon: 'FileText', roles: ['labScientist'] },
