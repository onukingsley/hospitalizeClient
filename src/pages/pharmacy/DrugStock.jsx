...
const DrugStock = () => {
  ...
  else if (filter === 'restockRequest') displayedDrugs = drugRestockRequest;
  else if (filter === 'myRequest') displayedDrugs = myDrugRestockRequest;
  else if (filter === 'pendingRequest') displayedDrugs = pendingDrugRestockRequest;
...
console.log(drugRestockRequest)
  ...
  const handleSubmitRequest = async () => {
    ...
    try {
      ...
      axiosClient.post('/drugRestockRequest', payload)
          .then(({data})=>{
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Card className="p-4 flex items-center gap-4 cursor-pointer hover:shadow-md transition-all" onClick={() => setFilter('all')}>
            ...
            <div><p className="text-2xl font-bold">{drugs.length}</p><p className="text-sm text-muted-foreground">Total Drugs</p></div>
          </Card>
          <Card className="p-4 flex items-center gap-4 cursor-pointer hover:shadow-md transition-all" onClick={() => setFilter('low')}>
            ...
            <div><p className="text-2xl font-bold text-red-600">{lowStock.length}</p><p className="text-sm text-muted-foreground">Low Stock</p></div>
          </Card>
          <Card className="p-4 flex items-center gap-4 cursor-pointer hover:shadow-md transition-all" onClick={() => setFilter('outOfStock')}>
            ...
            <div><p className="text-2xl font-bold text-yellow-600">{outOfStock.length}</p><p className="text-sm text-muted-foreground">Out Of Stock</p></div>
          </Card>
          <Card className="p-4 flex items-center gap-4 cursor-pointer hover:shadow-md transition-all" onClick={() => setFilter('pending')}>
            ...
            <div><p className="text-2xl font-bold text-yellow-600">{pendingDrugs.length}</p><p className="text-sm text-muted-foreground">Pending</p></div>
          </Card>
          <Card className="p-4 flex items-center gap-4 cursor-pointer hover:shadow-md transition-all" onClick={() => setFilter('pending')}>
            ...
            <div><p className="text-2xl font-bold text-yellow-600">{drugRestockRequest.length}</p><p className="text-sm text-muted-foreground">Restock Request</p></div>
          </Card>
        </div>
