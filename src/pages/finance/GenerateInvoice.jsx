...
const GenerateInvoice = () => {
    ...
    const handleSearchPatient = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await axiosClient.get(`/getGeneratedBill?details=${searchRegID}`);
    ...
    const renderInvoiceItem = (item, type, icon, label) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <PageHeader
                ...
                subtitle="Generate Patient's invoice for consultations, lab tests, and drug sales"
                actions={
                    <div className="flex items-center gap-2">
                                            ...
                                            <div className="space-y-3 pr-4">
                                                ...
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        navigate('/finance/invoiceDetails',{state: payload})
                                                        }}
